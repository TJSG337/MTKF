...
if __name__ == '__main__':
    os.chdir('/CV/xhr/xhr_project/Paper/Paper_joint/Yolo_Pose_Multi_21')
    parser = argparse.ArgumentParser()
    parser.add_argument('--weights', type=str, default='yolov5s.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='/CV/xhr/xhr_project/Paper/Paper_joint/Yolo_Pose_Multi_21/models/hub/yolov5s6_kpts_multi_big_sa.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='/CV/xhr/xhr_project/Paper/Paper_joint/Yolo_Pose_Multi_21/data/coco_kpts3090_multi2.yaml', help='data.yaml path')
    parser.add_argument('--hyp', type=str, default='data/hyp.scratch_kpts.yaml', help='hyperparameters path')
    ...
    if opt.resume and not wandb_run:  # resume an interrupted run
        ...
        # opt.hyp = opt.hyp or ('hyp.finetune.yaml' if opt.weights else 'hyp.scratch_kpts.yaml')
